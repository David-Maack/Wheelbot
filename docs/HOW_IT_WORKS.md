...
| `calendar` | Same-strike front/back calls, net debit | **LOW** IV (IVR ≤ 35 — inverted gate) | 25% of debit, force-close front ≤ 2 DTE. Triggers evaluate on MIDs, but the close ORDER is priced **marketably** (sell back at bid, buy front at ask) — calendars quote wide (20% spreads allowed), and mid-priced close limits cancel-looped without filling |
